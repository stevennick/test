...
[![Go Report Card](https://goreportcard.com/badge/github.com/stevennick/test)](https://goreportcard.com/report/github.com/stevennick/test)
...
Previously Gorsk was built using [Gin](https://github.com/gin-gonic/gin). Gorsk using Gin is available [HERE](https://github.com/stevennick/test-gin).
...
4. zxcvbn-go - Password strength checker
...
1. To use Gorsk as a starting point of a real project whose package name is something like `github.com/author/project`, move the directory `$GOPATH/github.com/stevennick/test` to `$GOPATH/github.com/author/project` and do a global replacement of the string `github.com/stevennick/test` with `github.com/author/project`.
